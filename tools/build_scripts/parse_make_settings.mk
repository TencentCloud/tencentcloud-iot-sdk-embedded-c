...
SWITCH_VARS := \
    ...
    FEATURE_RRPC_ENABLED \
    FEATURE_REMOTE_CONFIG_MQTT_ENABLED \
    FEATURE_RESOURCE_COMM_ENABLED \
    FEATURE_RESOURCE_SIGNAL_CHANNEL \
    FEATURE_REMOTE_LOGIN_WEBSOCKET_SSH \
    FEATURE_WEBSOCKET_MQTT \
...
ifeq (y, $(strip $(FEATURE_WEBSOCKET_MQTT)))
CFLAGS += -DWEBSOCKET_CLIENT
else ifeq (y, $(strip $(FEATURE_REMOTE_LOGIN_WEBSOCKET_SSH)))
CFLAGS += -DWEBSOCKET_CLIENT
endif
...
ifeq (y, $(strip $(FEATURE_REMOTE_CONFIG_MQTT_ENABLED)))
CFLAGS += -DREMOTE_CONFIG_MQTT
endif

ifeq (n, $(strip $(FEATURE_AUTH_WITH_NOTLS)))
ifeq (y, $(strip $(FEATURE_OTA_USE_HTTPS)))
CFLAGS += -DOTA_USE_HTTPS
endif
ifeq (y, $(strip $(FEATURE_RESOURCE_USE_HTTPS)))
CFLAGS += -DRESOURCE_USE_HTTPS
ifeq (n, $(strip $(FEATURE_OTA_USE_HTTPS)))
CFLAGS += -DOTA_USE_HTTPS
endif
endif
endif
