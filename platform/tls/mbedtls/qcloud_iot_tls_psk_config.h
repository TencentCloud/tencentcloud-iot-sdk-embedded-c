...
#if defined(AUTH_MODE_CERT) || defined(WEBSOCKET_MQTT) || defined(OTA_USE_HTTPS) || defined(RESOURCE_USE_HTTPS)
...
#define MBEDTLS_SSL_MAX_CONTENT_LEN 3800
#define MBEDTLS_SSL_CIPHERSUITES    MBEDTLS_TLS_RSA_WITH_AES_128_CBC_SHA, MBEDTLS_TLS_PSK_WITH_AES_128_CBC_SHA, MBEDTLS_TLS_PSK_WITH_AES_256_CBC_SHA
