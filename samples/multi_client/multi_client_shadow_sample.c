...
static unsigned int sg_thread_status[MAX_MQTT_THREAD_COUNT];
    ...
    char *device_info_file[MAX_MQTT_THREAD_COUNT] = {
        ".\\cert_device_info1.json", ".\\cert_device_info2.json", ".\\cert_device_info3.json"
    };
#else
    char *device_info_file[MAX_MQTT_THREAD_COUNT] = {
        ".\\psk_device_info1.json", ".\\psk_device_info2.json", ".\\psk_device_info3.json"
    };
#endif
#else
#ifdef AUTH_MODE_CERT
...
static void _shadow_client_thread_runner(void *ptr)
{
    ...
    while (IOT_Shadow_IsConnected(shadow_client) || QCLOUD_ERR_MQTT_ATTEMPTING_RECONNECT == rc ||
        ...
        rc = IOT_Shadow_Update(shadow_client, shadow_json_buffer, shadow_json_buf_size, 
...
int main(int argc, char **argv)
{
    ...
    char *property_key[MAX_MQTT_THREAD_COUNT] = {
        "update_count_1", "update_count_2", "update_count_3"
    };
